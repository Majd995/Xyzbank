...
public class TestCasess {
	...
	public void selestname() throws InterruptedException {
		...
		Select selector = new Select(nameselct);

		List<WebElement> opiton = nameselct.findElements(By.tagName("option"));
		int randomuser = rand.nextInt(1, opiton.size());
		selector.selectByIndex(randomuser);
		Thread.sleep(2000);
		WebElement logingbtn = driver.findElement(By.cssSelector("[type='submit']"));
		logingbtn.click();
	...
	public void Bankmangerl() throws InterruptedException {
		...
		WebElement Bankmangerl = driver.findElement(By.cssSelector("[ng-click=\'manager()\']"));
		Bankmangerl.click();
		Thread.sleep(3000);
		WebElement addcustmerl = driver.findElement(By.cssSelector("[ng-class=\'btnClass1']"));
		addcustmerl.click();
	}
	...
	public void Addcustmer() throws InterruptedException {
		...
		String[] names = { "ahamd", "kaled", "ammer", " majd", "malek", "Sara", "Hadeel", "Omar", "Lina", "Yousef",
				"Mona", "Samir", "Dina", "Tariq" };
	...
	public void OpenAccount() throws InterruptedException {
		...
		List<WebElement> option = nameSelect.findElements(By.tagName("option"));
		int randomuser1 = rand.nextInt(1, option.size());
		selector.selectByIndex(randomuser1);
